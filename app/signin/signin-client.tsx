...
export default function SignInPage() {
      ...
      if (authMethod === "email") {
        const { error: signInError } = await supabase.auth.signInWithOtp({
          ...
          options: {
            ...
            emailRedirectTo: `${window.location.origin}/constellation`,
          },
        });
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // routing logic for signin: use returnTo if present, else check persona
      if (returnTo) {
        // Redirect back to the page they were trying to reach
    ...
    <main className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center px-4 animate-fade-in">
      ...
      <div style={cardStyle}>
        ...
        {formState === "otp" ? (
          ...
          <form onSubmit={handleSendCode} aria-label="sign in to your account">
            {/* Method buttons */}
            <div 
